...
{
    /// <summary>
    /// Interaction logic for MainForm.
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            using (var stream = GetType().Assembly.GetManifestResourceStream("SmtpOAuthWinFormApp_IdentityClient.MailIcon.ico"))
            {
        ...
        private async void SignButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                statusLabel.Text = "Authenticating via Microsoft 365...";
                ...
                statusLabel.Text = "Successfully authenticated.";
            }
            catch (Exception ex)
            {
        ...
        private async void RefreshButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    statusLabel.Text = "Nothing to refresh. Please sign in first.";
                    return;
                }
                ...
                statusLabel.Text = "Token refreshed successfully.";
            }
            catch (Exception ex)
            {
                statusLabel.Text = "Failure.";
